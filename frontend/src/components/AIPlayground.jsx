...
const AIPlayground = () => {
  ...
  return (
    <section className="split-section" id="ai-playground">
      {/* Left Half - AI Playground Interface (White Background) */}
        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="display-medium text-gray-900">AI Playground</h2>
            </div>
            ...
            <div className="mb-6">
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-32 bg-white border-2 border-gray-200 p-4 text-gray-900 placeholder-gray-500 resize-none focus:border-brand-primary focus:outline-none transition-colors"
                  disabled={isLoading}
                />
                <motion.button
            ...
            <div>
              <p className="body-medium text-gray-600 mb-4">Try these examples:</p>
              <div className="space-y-2">
                {suggestedChallenges.map((challenge) => (
                  <motion.button
                    key={challenge}
                    onClick={() => handleSubmit(challenge)}
                    className="block w-full text-left p-3 bg-gray-50 border border-gray-200 hover:border-brand-primary text-gray-700 hover:text-brand-primary transition-all duration-300"
                    whileHover={{ x: 5 }}
                    disabled={isLoading}
                  >
                    "{challenge}"
          ...
          {!response && !isLoading && (
            ...
            >
              <div>
                ...
                <h3 className="heading-2 mb-4 text-white">Ready to solve your challenge</h3>
          ...
          {isLoading && (
            ...
            >
              <div className="text-center">
                ...
                />
                <h3 className="heading-3 mb-2 text-white">Analyzing your challenge...</h3>
                <p className="body-medium text-gray-300">Our AI is crafting personalized recommendations</p>
              </div>
            </motion.div>
          )}
                  ...
                  <ul className="space-y-3">
                    {response.bullets.map((bullet, index) => (
                      ...
                      >
                        ...
                        <span className="body-medium text-gray-300">{bullet}</span>
                      </motion.li>
                    ))}
                  </ul>
                </div>
                  ...
                  <ol className="space-y-3">
                    {response.tasks.map((task, index) => (
                      <motion.li
                        ...
                        className="flex items-start gap-3"
                      >
                        <span className="w-6 h-6 bg-brand-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                          {index + 1}
                        </span>
                        <span className="body-medium text-gray-300">{task}</span>
                      </motion.li>
                    ))}
                  </ol>
                </div>
